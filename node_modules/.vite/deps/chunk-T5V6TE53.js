...
import {
  require_react_dom
} from "./chunk-EHH7E4YR.js";
import {
  require_jsx_runtime
} from "./chunk-ZEN2TP7N.js";
import {
  require_react
} from "./chunk-3E552KSL.js";
import {
  push,
  resolveAll,
  splice,
  visit
} from "./chunk-SUM2BS5M.js";
import {
  CONTINUE,
  EXIT,
  SKIP,
...
var Tokenizer = class {
  ...
  _err(code4, cpOffset = 0) {
    var _a3, _b;
    (_b = (_a3 = this.handler).onParseError) === null || _b === void 0 ? void 0 : _b.call(_a3, this.preprocessor.getError(code4, cpOffset));
  }
...
`, e = e.substring(Z2.length + 1), d2 = A2.slice(f2);
  ...
  table(e) {
    ...
    let n = V2(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = ((_a3 = t[3]) == null ? void 0 : _a3.trim()) ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e, t = [], n = false) {
    ...
    for (this.tokenizer.lexer = this, this.options.pedantic && (e = e.replace(m2.tabCharGlobal, "    ").replace(m2.spaceLine, "")); e; ) {
      let r;
      if ((_b = (_a3 = this.options.extensions) == null ? void 0 : _a3.block) == null ? void 0 : _b.some((s2) => (r = s2.call({ lexer: this }, e, t)) ? (e = e.substring(r.raw.length), t.push(r), true) : false)) continue;
...
` + r.raw, this.inlineQueue.at(-1).src = s2.text) : this.tokens.links[r.tag] || (this.tokens.links[r.tag] = { href: r.href, title: r.title }, t.push(r));
      ...
      if (this.state.top && (r = this.tokenizer.paragraph(i))) {
        let s2 = t.at(-1);
        n && (s2 == null ? void 0 : s2.type) === "paragraph" ? (s2.raw += (s2.raw.endsWith(`
`) ? "" : `
`) + r.raw, s2.text += `
...
var y2 = class {
  ...
  code({ text: e, lang: t, escaped: n }) {
    var _a3;
    let r = (_a3 = (t || "").match(m2.notSpaceStart)) == null ? void 0 : _a3[0], i = e.replace(m2.endingNewline, "") + `
`;
...
var D2 = class {
  constructor(...e) {
    ...
    __publicField(this, "TextRenderer", $3);
...
var cr = (0, import_react.lazy)(() => import("./highlighted-body-OFNGDK62-U766UJAR.js").then((e) => ({ default: e.HighlightedCodeBlockBody })));
...
var os = (0, import_react.lazy)(() => import("./mermaid-GHXKKRXX-K2EJKFW4.js").then((e) => ({ default: e.Mermaid })));
var ns = /language-([^\s]+)/;
function qe2(e, t) {
...
//# sourceMappingURL=chunk-T5V6TE53.js.map
